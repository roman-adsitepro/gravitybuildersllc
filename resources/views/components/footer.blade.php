      ...
      <div class="mt-16 grid grid-cols-2 gap-8 xl:col-span-2 xl:mt-0">
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div class="mt-10 md:mt-0">
            ...
            <ul role="list" class="mt-6 space-y-4">
              ...
              <li>
                <a href="{{ route('faq') }}" class="text-sm/6 text-gray-600 hover:text-gray-900">Frequently asked questions</a>
              </li>
            </ul>
          </div>
        ...
        <div class="md:grid md:grid-cols-2 md:gap-8">
          ...
          <div>
            ...
            <ul role="list" class="mt-6 space-y-4">
              <li>
                <a href="{{ route('about') }}" class="text-sm/6 text-gray-600 hover:text-gray-900">About</a>
              </li>
              <li>
                <a href="{{ route('reviews') }}" class="text-sm/6 text-gray-600 hover:text-gray-900">Reviews</a>
              </li>
            </ul>
          </div>
